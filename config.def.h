...
static const Rule rules[] = {
    /* app_id             title       tags mask     isfloating   isterm
       noswallow   monitor  appicon*/
    /* examples: */
    {"foot", NULL, 0, 0, 1, 1, -1, NULL},
    {"Gimp_EXAMPLE", NULL, 0, 1, 0, 0,
     -1, NULL}, /* Start on currently visible tags floating, not tiled */
    {"firefox_EXAMPLE", NULL, 1 << 8, 0, 0, 0, -1, "󰈹"}, /* Start on ONLY tag "9" */
};
...
static const MonitorRule monrules[] = {
    ...
    */
    ...
    {NULL, 0.5f, 1, 1.6, &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL, -1, -1, 0, 0,
     0.0f, 0, 0},
};
